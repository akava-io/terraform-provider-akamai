...
func resourceActivationsCreate(d *schema.ResourceData, meta interface{}) error {
	CorrelationID := "[APPSEC][resourceActivationsCreate-" + CreateNonce() + "]"
	...
	postpayload.NotificationEmails = setToStringSlice(d.Get("notification_emails").(*schema.Set))
...
func resourceActivationsDelete(d *schema.ResourceData, meta interface{}) error {
	CorrelationID := "[APPSEC][resourceActivationsDelete-" + CreateNonce() + "]"
...
func resourceActivationsRead(d *schema.ResourceData, meta interface{}) error {
	CorrelationID := "[APPSEC][resourceActivationsRead-" + CreateNonce() + "]"
